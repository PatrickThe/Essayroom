...
<body class="materialdesign">
                                ...
                                <div class="col-lg-3">
                                    <div class="inbox-email-menu-list compose-b-mg-30 shadow-reset">
                                        ...
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li><a data-toggle="tab" href="#viewmail"><span class="inbox-icon"><i class="fa fa fa-inbox "></i></span> View Mail</a>
                                            </li>
    ...
    <div class="chat-list-wrap">
        ...
        $query="SELECT * from message_chat Where from_user!='admin' order by date asc";
        $result_set=mysqli_query($conn,$query);
        while($row=mysqli_fetch_object($result_set)){
    
        echo "<div class='author-chat'>";
        echo"<h3>$row->from_user <span class='chat-date'></span></h3>";
            echo " <p>$row->content</p>";
             echo "<h10>$row->date</h10><br>";
        echo "</div>";
...
<?php
        ...
        echo"<h3>Me <span class='chat-date'></span></h3>";
            echo " <p>$row->content</p>";
             echo "<h10>$row->date</h10><br>";
        echo "</div>";
...
?>
                    ...
                    <div class="chat-send">
                       <textarea id="content" rows="4" cols="85"></textarea><br/>
                    <input type="hidden" value="patoh@gmail.com" id="to_user">
                    <input type="hidden" value="admin" id="from_user">
                        <span><button type="submit" id="msg">Send</button></span>
                    </div>
                </div>
            </div>
        </div>

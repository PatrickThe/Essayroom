                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-12">
                                                                            <div class="basic-login-inner modal-basic-inner">
                                                                                <form action="setconstant.php" method="post">
                                                                                    <div class="form-group-inner">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-lg-8">
                                                                                                <input type="text" name="task_name" class="form-control" placeholder="Name" required="Compulsory" />
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group-inner">
...
if (isset($_POST['save'])) { // if save button on the form is clicked
 ...
 $sql1 = "INSERT INTO order_task (task_name,rate) VALUES ('$task_name','$rate')";
...
$result_set=mysqli_query($conn,$query);
            ...
            $rate=$row['rate'];
                                                    ...
                                                    <td><input type='text' name='id' value='<?php echo $id ?>'/hidden>
                                                     ...
                                                     <td><?php echo $rate ?></td>
                                                     <td><button class="btn btn-sm btn-primary login-submit-cs" name="delete1" type="submit">DELETE</button>
                                                     </td>
                                                      </form>
                                                    <?php
 require_once("include/connection.php");
...
if (isset($_POST['delete1'])) { // if save button on the form is clicked
    // name of the uploaded file
$id=$_POST['id'];
 
 mysqli_query($conn,"delete from order_task where id='$id'")or die(mysqli_error($conn));

...
$result_set=mysqli_query($conn,$query);
            ...
            $rate=$row['rate'];
                                                    ...
                                                    <td><input type='text' name='id' value='<?php echo $id ?>'/hidden></td>
                                                     ...
                                                     <td><?php echo $rate ?></td>
                                                     <td><button class="btn btn-sm btn-primary login-submit-cs" name="deletew" type="submit">DELETE</button>
                                                     </td>
                                                     </form>
                                                    <?php
 require_once("include/connection.php");
...
if (isset($_POST['deletew'])) { // if save button on the form is clicked
    // name of the uploaded file
$id=$_POST['id'];

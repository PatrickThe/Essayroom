                                                                                        ...
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-lg-8">
                                                                                                <div class="login-horizental">
                                                                                                    <button class="btn btn-sm btn-primary login-submit-cs" name="save1" type="submit">ADD</button>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
...
?>
         ...
         require_once("include/connection.php");
            ...
            $query="SELECT * FROM order_subject ";
$result_set=mysqli_query($conn,$query);
            ...
            $rate=$row['rate'];
                                                    ...
                                                    <td><input type='text' name='id' value='<?php echo $id ?>'/hidden></td>
                                                     ...
                                                     <td><?php echo $rate ?></td>
                                                     <td><button class="btn btn-sm btn-primary login-submit-cs" name="deletek" type="submit">DELETE</button>
                                                     </td>
                                                      </form>
                                                    <?php
 require_once("include/connection.php");
...
if (isset($_POST['deletek'])) { // if save button on the form is clicked
    // name of the uploaded file
$id=$_POST['id'];
 
 mysqli_query($conn,"delete from `order_subject` where `id`='$id'")or die(mysqli_error($conn));

...
<head>
  ...
  <title>About Essayroom | Find out about the Best Online EssayWriting Service</title>
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
              <li class="nav-item"><a class="nav-link" href="index.php">Home</a></li>      
                  <li class="nav-item active"><a class="nav-link" href="blog.php">Main Blog</a></li>
...
<section class="product_description_area">
    <div class="container">
      <p class="text-center billing-alert">How to Order</p>
      <ul class="nav nav-tabs" id="myTab" role="tablist" style="background-color:lightgray">
        <li class="nav-item">
                              ...
                              <div class="blog_post">
                                  ...
                                  <div class="blog_details">
                                      ...
                                      <p>MCSE boot camps have its supporters and its detractors. Some people do not understand
                                          why you should have to spend money on boot camp when you can get the MCSE study
                                          materials yourself at a fraction.</p>
                                      <a href="#" class="button button-blog">View More</a>
                                  </div>
                              </div>
                          </div>
                      </article>

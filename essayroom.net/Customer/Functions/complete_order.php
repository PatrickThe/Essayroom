<?php include 'header.php' ;?>
    ...
    <section id="unseen">
             ...
             require_once("include/connection.php");
              ...
              $r = mysqli_query($conn,"SELECT * FROM order_file where email_address = '$userid'") or die (mysqli_error());
            ...
            ?>
             ...
             $query=mysqli_query($conn,"SELECT * FROM customer_file where order_id='$order_id'") or die(mysqli_error());

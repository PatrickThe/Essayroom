...
<form action="../Functions/server.php" method="POST" enctype="multipart/form-data">
    ...
    function task(thisObj)
{
  ...
  document.getElementById('show').value = thisObj.options[thisObj.selectedIndex].text;
    ...
    <input type="text" name="topic" class="form-control col-sm-12 border-default" id="order_title" aria-describedby="emailHelp" placeholder="Enter topic" ></div>
...
<?php 
  ...
  <input type="hidden" id='show1' name="subject_id" />
  <script type="text/javascript">
...
<?php 
 ...
 <input type="hidden" id='show2' name="deadline_id" />
  <script type="text/javascript">
...
<input type="hidden" id='Academic' name="academic_level_id" />
  <script type="text/javascript">

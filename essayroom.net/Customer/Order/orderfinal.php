...
<head>
  ...
  <title>EssayRoom.net | Order Essay Now</title><!-- Bootstrap core CSS --><!-- Custom fonts for this template -->
...
<br><br><br><br><script>
  ...
  <div class="form-group">
    ...
    <select name=""  class="form-control custom-select border-default col-sm-12" id="task_id" onClick="task(this)">
 <option value="" class="text-center"></option><?php 
                  //query for courses
    ...
    function task(thisObj)
{
  ...
  document.getElementById('show').value = thisObj.options[thisObj.selectedIndex].text;
   ...
   <select name="" class="form-control col-sm-12 custom-select border-default" id="subject_id" onClick="showSelected1(this)">
...
<div class="row col-sm-12 wordcount">  275 word approx </div>
   ...
   <select name="" class="col-sm-12 form-control  custom-select border-default" id="deadline_id" onClick="showSelected(this)">
 <option value="" class="text-center"></option>
<?php 
                  //query for courses
    ...
    function showSelected(thisObj)
{
  ...
  <div class="form-group">
    ...
    <select name="" class="form-control custom-select border-default col-sm-12" id="academic_level_id" onClick="showSelected2(this)">
       <option value="" class="text-center"></option>
<?php 
                  //query for courses
...
$(function() {
    ...
    <select name="" class="form-control custom-select border-default col-sm-12" id="quality_id"  onClick="showSelected3(this)">

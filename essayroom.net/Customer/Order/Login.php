...
<form action="reguser.php" method="POST">
  ...
  <div class="form-group">
    ...
    <div class="col-sm-12">
    <input type="email" name="email_address" class="form-control" id="inputEmail3" placeholder="Email address" required></div>
  </div>

      <div class="form-group">
      <label for="inputPassword3" class="col-sm-12 col-form-label text-muted">Password</label>
      <div class="col-sm-12">
        <input type="password" name="password_1" class="form-control" id="password" placeholder="Password" required></div>
      </div>
       <div class="form-group">
      <label for="inputPassword3" class="col-sm-12 col-form-label text-muted">Confirm Password</label>
      <div class="col-sm-12">
        <input type="password" name="password_2" class="form-control" id="confirm_password" placeholder="Password" required></div>
      </div>

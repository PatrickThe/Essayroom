	...
	<section class="login_box_area section-margin">
		<div class="container">
			<div class="row">
					...
					<div class="login_form_inner register_form_inner">
						...
						<form class="row login_form" action="Customer/login.php" id="register_form" method="POST">
							<div class="col-md-12 form-group">
								<input type="text" class="form-control" id="email" name="email_address" placeholder="Email Address" required="">
							</div>
							<div class="col-md-12 form-group">
              ...
              <div class="col-md-12 form-group">
								<input type="text" class="form-control" id="confirmPassword" name="password1" placeholder="Confirm Passwor" required="">
							</div>
							<div class="col-md-12 form-group">

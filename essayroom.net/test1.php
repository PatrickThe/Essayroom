...
<div class="col-sm-4">
<div class="opc1 row">
  <div class="col-sm-12"> <h3>Price Calculater</h3><hr style="margin-top: 0.5rem; margin-bottom: 0.2rem;"></div>
...
<hr style="margin-top: 0.5rem; margin-bottom: 0.2rem;"><a class="text-center btn btn-success col-sm-12" href="Customer/Order/orderfinal.php"> Continue with order </a>
</div>
</div>

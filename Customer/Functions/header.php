...
if ($last_noti_id > $last_seen_noti) {
  $number_of_noti_to_show_to_user = $last_noti_id - $last_seen_noti;
}else{$number_of_noti_to_show_to_user = 0;
}

else{
   $number_of_noti_to_show_to_user = 0;
}
?>
...
<body>
  ...
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="../login.php" class="logo"><b>Essay<span>Room</span></b></a>
      <!--logo end-->
            ...
            <ul class="dropdown-menu extended notification">
             ...
             <form method="POST" action="" >
              <input type="hidden" name="email_address" value="<?php echo $email_address ; ?>">
               <input type="hidden" name="last_seen_noti" value="<?php echo $last_seen_noti+1 ; ?>">
             <input type="submit" value="notifications" name="noted" />
             <?php 
...
$last_seen_noti =$_POST['last_seen_noti'];
$email_address=$_POST['email_address'];
          
 mysqli_query($conn,"UPDATE login_user SET last_seen_noti='$last_seen_noti' WHERE  email_address='$email_address'")or die(mysqli_error($conn));
         ...
         <li class="sub-menu">
            ...
            <ul class="sub">
              ...
              <li><a href="chat.php"> Chat With Admin</a></li>
                <li><a href="chating.php"> Chat testing</a></li>
            </ul>
          </li>
           <li class="sub-menu">
            <a href="javascript:;">
          ...
          <li>
            <a href="credit.php">
              ...
              <span>Essayroom Balance </span>
              <span class="label label-theme pull-right mail-info"><?php echo ucwords(htmlentities($account_bal)); ?></span>
              </a>
          </li>
           <li>
            
              <li><a href="referal.php">Referal Link</a></li>

...
<link rel="stylesheet" type="text/css" href="../Order/css/dropzone-basic.min.css">
...
<button id="btnone"  type="button" data-toggle="collapse" data-target="#multiCollapseExample1" aria-expanded="false" aria-controls="multiCollapseExample2">Go To Step 2/3</button>
  ...
  <div class="input-group col-sm-12">
   ...
   <div class="form-group">
      ...
      <div class="col-sm-12">
           ...
           <select name="order_citation" class="form-control custom-select border-default col-sm-12" id="exampleSelecte1">
    ...
    <textarea class="border-default" height="110px" name="order_instructions" id="editor" placeholder="Describe your order details here..."></textarea><script>
        ...
        <button id="btntwo"  type="button" data-toggle="collapse" data-target="#multiCollapseExample2" aria-expanded="false" aria-controls="multiCollapseExample2">Go To Step 3/3</button>

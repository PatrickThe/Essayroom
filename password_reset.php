        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
            <ul class="nav navbar-nav menu_nav ml-auto mr-auto">
             ...
             <li class="nav-item"><a class="nav-link " href="How_it-works.php">How it Works</a></li>
			...
			<div class="row" style="background-color: lightgreen">
				<div class="col-lg-6">
					<div class="login_box_img">
						<div class="hover">
							<h4>we will send you a code to change your password</h4>
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="Customer/recovery.php" id="contactForm" method="POST">
...
?>
								<input type="hidden" class="form-control" id="name" name="pass_code" value="<?php echo generate_string($permitted_chars, 6); ?>">
							</div>
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" name="ResetPass" class="button button-login w-100">Send Me A code</button>
